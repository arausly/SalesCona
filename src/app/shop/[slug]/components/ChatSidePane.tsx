    ...
    return (
        ...
        >
            ...
            <span
                ...
                className={`fixed opacity-30 z-30 transition top-0 right-0 bottom-0 left-0 bg-black ${
                    isOpen ? "inline-block" : "hidden z-10"
                }`}
            />
            <div
                className={`fixed z-30 top-0 right-0 bottom-0 transition ease-in-out shadow-md h-full flex w-full flex-col bg-white p-8 md:w-3/5 lg:w-2/5 ${
