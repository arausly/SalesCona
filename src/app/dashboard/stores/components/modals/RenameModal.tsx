    ...
    return (
        <Modal title="Rename store" isOpen={isOpen} toggleModal={toggleModal}>
            ...
            <div className="mt-4 flex items-center justify-end">
                ...
                <button
                    type="button"
                    className="inline-flex justify-center rounded-md border border-transparent primary-bg px-4 py-2 text-sm font-medium text-white hover:bg-blue-700 transition ease-in-out focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2"
                    onClick={toggleModal}
                >
                    Yes, rename
                </button>
